# ระบบสแกนสลิป BCEL One (เวอร์ชั่น 0.3.9)
...
# ตั้งค่า Tesseract (เฉพาะ Windows)
...
if not df_history.empty:
    ...
    st.download_button("ดาวน์โหลดไฟล์ Excel", data=buffer.getvalue(), file_name="slip_summary_039.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
